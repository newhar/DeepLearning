...
tf.flags.DEFINE_float("lr_decay", 0.95, "learning rate decay rate(default=0.1)")
# tf.flags.DEFINE_float("lr_decay", 1, "learning rate decay rate(default=0.1)")
...
tf.flags.DEFINE_integer("num_residual_units", 3, "The number of residual_units (default: 5)") #Resnet 20
# tf.flags.DEFINE_integer("num_residual_units", 5, "The number of residual_units (default: 5)") Resnet 32
