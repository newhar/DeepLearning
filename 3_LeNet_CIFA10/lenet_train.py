...
tf.flags.DEFINE_integer("lr_decay_steps", 5000, "learning rate decay step(default=5000)")
...
tf.flags.DEFINE_boolean("data_augmentation", False, "data augmentation option")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        print('early stop eapch: ', early_stop_step)
